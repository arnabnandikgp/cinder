...
/// I2: sum(user cash) == vault ATA + phoenix collateral ± in-flight USDC.
pub fn i2_holds(
    user_cash_sum: u64,
    vault_ata: u64,
    ...
    let lhs = user_cash_sum as i128;
    let rhs = vault_ata as i128 + phoenix_collateral as i128 + in_flight_usdc as i128;
    lhs == rhs
}
